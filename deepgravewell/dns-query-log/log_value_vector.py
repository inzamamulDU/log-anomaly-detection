...
if __name__ == '__main__':
    ...
    print("the example is like: 'result/messages_structured.csv', it is ’‘’")
   ...
   # append the timestamps to the log message
    ...
    #print(fd_linux['Time'][i])
        time_list.append(re.split(':|\\.', fd_linux['Time'][i]))
    ...
    log_value_vector_filename = 'result/log_value_vector.csv'
